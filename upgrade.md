...
- [ ] Добавить секцию `appFeatures` с возможностями приложения
- [ ] Добавить описания для: водяной знак, прицел, защита GPS, приватный режим

### 3. Обновление переводов ru.ts
- [ ] Аналогичная структура на русском языке

### 4. Обновление AppCapabilitiesDialog
- [ ] Добавить секцию "Возможности приложения" с иконками и описаниями

### 5. Тестирование
- [ ] Проверить отображение на разных языках
...
|--------|--------|------|
| Обновление upgrade.md | ✅ Готово | 10.12.2025 |
| Обновление en.ts | ⏳ В работе | 10.12.2025 |
| Обновление ru.ts | ⏳ Ожидает | - |
| Обновление AppCapabilitiesDialog | ⏳ Ожидает | - |
| Тестирование | ⏳ Ожидает | - |
