...
- [ ] Переименовать роут /visualEditorWatermark → /ve-watermark
- [ ] Изменить ширину водяного знака по умолчанию на 40%
- [ ] Исправить отображение гироскопа в одну строку
- [ ] Добавить Lucide иконки в водяной знак
...
| Переименование роута | 🔄 В процессе | 14.12.2025 |
| Ширина 40% | 🔄 В процессе | 14.12.2025 |
| Гироскоп в строку | 🔄 В процессе | 14.12.2025 |
| Lucide иконки | 🔄 В процессе | 14.12.2025 |
