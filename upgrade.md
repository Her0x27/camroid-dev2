...
## Текущая задача: Упрощение галереи
**Дата:** 2024-12-16
...
|------|----------|--------|
| 1 | Удалить кнопку и логику фильтрации | ✅ Готово |
| 2 | Обновить миниатюры: убрать GPS/заметки | ✅ Готово |
| 3 | Добавить отображение разрешения и веса фото | ⏳ Ожидает (данные не хранятся в схеме) |
