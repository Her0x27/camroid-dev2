...
- [ ] Убрать paddingTop и paddingBottom у контейнера изображения
- [ ] Оптимизировать прозрачность header/footer
...
| Полноэкранный режим | ⏳ В работе | 16.12.2025 |
| Прозрачность панелей | ⏳ В работе | 16.12.2025 |
