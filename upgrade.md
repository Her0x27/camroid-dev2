...
- [ ] Убрать Card, CardHeader, CardContent
- [ ] Счёт и лучший результат вверху экрана
- [ ] Игровое поле по центру
- [ ] Убрать лишние отступы и рамки

### 2. Notepad Native Style
- [ ] Полноэкранный чёрный фон
- [ ] Убрать Card, CardHeader, CardContent
- [ ] Список заметок слева (если есть)
- [ ] Область ввода на весь экран
- [ ] Минималистичный header с кнопками
...
| Задача | Статус | Дата |
|--------|--------|------|
| Game2048 Native Style | ⏳ В процессе | 10.12.2025 |
| Notepad Native Style | ⏳ В процессе | 10.12.2025 |
