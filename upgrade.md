...
## Описание
1. **Типы контента:** фото+папки | только папки | все фото
2. **Виды отображения:** список | таблица | большие значки
3. **Шапка:** хлебные крошки, переключатели типа/вида, кнопка закрытия
4. **Подвал при выборе:** скачать, удалить, загрузить в облако, получить ссылку
5. **Просмотр фото:** шапка/подвал НЕ поверх фото, только отступы сверху/снизу
6. **Свайпы:** вверх = назад, вниз = выход из галереи

## Чек-лист задач v74

- [ ] Обновить upgrade.md — добавить секцию v74
- [ ] Обновить типы отображения в useGalleryView.ts
- [ ] Добавить третий вид отображения 'large'
- [ ] Обновить GalleryHeader: хлебные крошки, переключатели
- [ ] Обновить подвал галереи при выборе
- [ ] Переделать photo-detail.tsx: шапка/подвал не поверх фото
- [ ] Изменить свайп вниз на 'выход из галереи'
...
| Задача | Статус | Дата |
|--------|--------|------|
| upgrade.md | 🔄 В работе | 16.12.2025 |
| useGalleryView.ts | ⏳ Ожидает | - |
| Вид 'large' | ⏳ Ожидает | - |
| GalleryHeader | ⏳ Ожидает | - |
| Подвал галереи | ⏳ Ожидает | - |
