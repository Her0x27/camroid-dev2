...
- [ ] Исправить мигание панели водяного знака — заменить onMouseUp/onTouchEnd на onPointerUp
- [ ] Реорганизовать данные: координаты + погрешность, гироскоп = высота + угол + азимут
...
| Мигание панели | ⏳ В работе | 14.12.2025 |
| Реорганизация данных | ⏳ В работе | 14.12.2025 |
