...
- [ ] Добавить обработку blur/focus событий в use-page-visibility.ts
- [ ] Изменить отступы разделителей в InteractiveWatermark.tsx (my-1 → mb-2)
- [ ] Обновить отрисовку разделителей в watermark-renderer.ts — отступ снизу
- [ ] Оптимизировать photo-detail.tsx для полноэкранного просмотра на мобильных
...
| Задача | Статус | Дата |
|--------|--------|------|
| upgrade.md | ⏳ В работе | 15.12.2025 |
| blur/focus события | ⏳ Ожидание | 15.12.2025 |
| Разделители React | ⏳ Ожидание | 15.12.2025 |
| Разделители Canvas | ⏳ Ожидание | 15.12.2025 |
| Галерея fullscreen | ⏳ Ожидание | 15.12.2025 |
