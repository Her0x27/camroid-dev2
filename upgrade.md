...
1. Увеличение размера Switch до стандартов мобильных платформ
2. Track: h-8 w-14 (32px × 56px) вместо h-6 w-11 (24px × 44px)
3. Thumb: h-7 w-7 (28px × 28px) вместо h-5 w-5 (20px × 20px)
4. Правильное смещение ручки при переключении (translate-x-6)
...
- [ ] Создать компонент SettingItem — полноценная карточка отдельной настройки
- [ ] Создать хук usePlatform — определение Android/iOS
- [ ] Обновить MainSettingsTab — использовать SettingItem для всех настроек
- [ ] Обновить PrivacyTab — улучшить стилизацию
- [ ] Обновить StorageTab — улучшить стилизацию
- [ ] Добавить переводы для новых описаний и рекомендаций
