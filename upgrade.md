...
- [ ] Photo-detail.tsx: добавить иконку загрузки в облако
- [ ] Photo-detail.tsx: добавить иконку копирования ссылки
- [ ] GalleryFolderList: добавить кнопки Upload/Get Links на папки
...
| Photo-detail icons | ⏳ В процессе | 16.12.2025 |
| Folder buttons | ⏳ Ожидает | - |
