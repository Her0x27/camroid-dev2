...
- [ ] Добавить breadcrumbs в шапку photo-detail
- [ ] Разделить свайпы: вверх = галерея, вниз = камера
- [ ] Добавить визуальные индикаторы свайпа
...
| Breadcrumbs | ⏳ В процессе | 16.12.2025 |
| Свайпы вверх/вниз | ⏳ Ожидает | - |
| Визуальные индикаторы | ⏳ Ожидает | - |
| Мобильная адаптация | ⏳ Ожидает | - |
