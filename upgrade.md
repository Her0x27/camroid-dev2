...
- [ ] Создать LazyLoaderContext для отслеживания прогресса
- [ ] Создать функцию createTrackedLazy() для обёртывания lazy-импортов
- [ ] Обновить SplashScreen для отображения реального прогресса
- [ ] Обновить App.tsx с новыми tracked lazy компонентами
...
| Задача | Статус | Дата |
|--------|--------|------|
| LazyLoaderContext | ⏳ В работе | 11.12.2025 |
| createTrackedLazy | ⏳ В работе | 11.12.2025 |
| SplashScreen | ⏳ Ожидает | - |
| App.tsx | ⏳ Ожидает | - |
