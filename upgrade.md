...
# Upgrade: Исправление локализации облачных провайдеров (v7)

## Описание
Исправление локализации секции "Облако" — убрать привязку к ImgBB в заголовке и описании, так как теперь есть выбор провайдеров.

## Чек-лист задач

### 1. Обновление локализации
- [x] Убрать "(ImgBB)" из заголовка секции cloud в ru.ts
- [x] Убрать "(ImgBB)" из заголовка секции cloud в en.ts
- [x] Обновить описание секции cloud в ru.ts
- [x] Обновить описание секции cloud в en.ts
...
| Задача | Статус | Дата |
|--------|--------|------|
| Обновление локализации | ✅ Готово | 09.12.2025 |
