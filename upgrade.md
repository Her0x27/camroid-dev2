...
- [ ] Обновить переводы — расширенное описание, новые заголовки секций
- [ ] Реорганизовать app-capabilities-dialog.tsx — новый порядок и оформление секций
