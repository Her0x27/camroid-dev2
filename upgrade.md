...
- [ ] Исправить камеру — остановка при сворачивании/переключении вкладки
- [ ] Исправить камеру — не включать до закрытия окна Welcome
- [ ] Улучшить видимость границ окна Welcome
- [ ] Переработать раздел "Функции приложения"
...
| Visibility change | ⏳ В процессе | 12.12.2025 |
| Welcome синхронизация | ⏳ В процессе | 12.12.2025 |
| Границы окна | ⏳ В процессе | 12.12.2025 |
| Функции приложения | ⏳ В процессе | 12.12.2025 |
