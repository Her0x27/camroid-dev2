...
- [ ] Убрать Dialog, заменить на фиксированную panel
- [ ] Добавить slide-in анимацию снизу/справа
- [ ] Компактный header с кнопкой закрытия
- [ ] Scrollable контент внутри панели

### 2. Стилизация
- [ ] Backdrop blur эффект
- [ ] Тень и градиентная рамка
- [ ] Компактные секции контента

### 3. Анимации
- [ ] Плавное появление (slide + fade)
- [ ] Анимация закрытия
...
| Задача | Статус | Дата |
|--------|--------|------|
| Notification Panel | ⏳ В процессе | 10.12.2025 |
| Стилизация | ⏳ В процессе | 10.12.2025 |
| Анимации | ⏳ В процессе | 10.12.2025 |
