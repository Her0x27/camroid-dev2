...
## Текущая задача: Обновление анимации splash-screen
**Дата:** 2024-12-16

### Описание
Создать новую анимацию заставки с последовательностью:
...
1. **hand** → Рука переворачивает камень (0.8с)
2. **camera** → Появляется камера с вспышкой (0.6с)
3. **text** → Буквы собираются в название (1.2с)
