...
- [ ] Создать компонент ConfigExportImport с диалогами
- [ ] Добавить переводы в en.ts и ru.ts
- [ ] Интегрировать компонент в watermark-preview/index.tsx
...
| ConfigExportImport | 🔄 В процессе | 13.12.2025 |
| Переводы | ⏳ Ожидает | - |
| Интеграция | ⏳ Ожидает | - |
