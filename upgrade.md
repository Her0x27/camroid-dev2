...
- [ ] Добавить isIOS() и isAndroid() функции в app-capabilities.ts

### 2. AndroidCalculator.tsx
- [ ] Полноэкранный чёрный фон
- [ ] История вычислений вверху (мелкий серый текст)
- [ ] Текущее выражение справа (крупный шрифт)
- [ ] Live preview результата под выражением (= xxx)
- [ ] Прямоугольные кнопки со скруглением
- [ ] Кнопки: C, ⌫ (backspace), %, ÷
- [ ] Оранжевые операторы справа (÷, ×, −, +, =)
- [ ] Кнопка истории (₀₂) слева внизу

### 3. iOSCalculator.tsx
- [ ] Полноэкранный чёрный фон
- [ ] Только дисплей справа (большой белый шрифт)
- [ ] Круглые кнопки (border-radius: 50%)
- [ ] Серые кнопки: AC, ±, %
- [ ] Оранжевые круглые кнопки: ÷, ×, −, +, =
- [ ] Кнопка 0 двойной ширины

### 4. Интеграция
- [ ] Обновить Calculator.tsx для автовыбора по платформе
- [ ] Сохранить логику секретной разблокировки
...
| Задача | Статус | Дата |
|--------|--------|------|
| Утилита платформы | ⏳ В процессе | 10.12.2025 |
| AndroidCalculator | ⏳ В процессе | 10.12.2025 |
| iOSCalculator | ⏳ В процессе | 10.12.2025 |
| Интеграция | ⏳ В процессе | 10.12.2025 |
